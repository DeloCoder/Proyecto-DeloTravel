...
boton.addEventListener("click", () => {
  let ayudaBoton = prompt("Recibimos su solicitud de asistencia, podria por favor indicar motivo por la cual solicita ayuda?");
  console.log("El cliente solicita ayuda desde el boton porque: " +ayudaBoton)});

...
alert(
  "Bienvenido a la terminal Autoservicio de Delo Viajes"); 
alert( 
  "Por favor ingrese a continuacion los datos que solicita el sistema"
);
...
function pasajeMendoza() {
  ...
  alert("Estimado Cliente, su pasaje a Mendoza sera emitido y enviado al Email registrado");
...
function pasajeSantiagoDeChile() {
  ...
  alert("Estimado Cliente, su pasaje a Santiago De Chile sera emitido y enviado al Email registrado");
...
function pasajeBogota() {
  ...
  alert("Estimado Cliente, su pasaje a Bogota sera emitido y enviado al Email registrado");
...
function pasajePuntaCana() {
  ...
  alert("Estimado Cliente, su pasaje a Punta Cana sera emitido y enviado al Email registrado");
...
function seguirComprando() {
  ...
  switch (comprar) {
    ...
    case 3: {
      alert("En breve un agente se contactara con Usted, para solucionar sus requerimientos. Gracias por su paciencia!");
      console.log("ATENCION!!! Requerimiento de contacto del cliente!!! ");
      break;
    }
  }

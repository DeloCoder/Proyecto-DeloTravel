...
do {
  class Usuario {
    constructor(nombre, documento, email, fechaDeIda, fechaDeVuelta) {
      ...
      this.destinos = destinos; /*por que si no pongo cero aca no funca?*/
    }
  }
  ...
  function registrarUsuario() {
    ...
    let fechaDeVuelta = prompt("Fecha de Vuelta solicitada  ingrese Dia/mes/ano");
  ...
  function seguirComprando() {
    comprar = Number(
      prompt(` 
    Si Ud desea AGREGAR otro pasaje a su carrito presione 1.
